...
const projects = [
    ...
    },
    {
        ...
        className:
            "md:col-span-6 md:row-span-1 lg:col-span-9 lg:row-span-1 2xl:col-span-6 2xl:row-span-1  ",
    },
    {
        image: joopi,
        title: "Joopi",
    ...
    },
    {
        ...
        link: "https://example.com/project1",
        className:
            "md:col-span-6 md:row-span-1 lg:col-span-6 lg:row-span-1 2xl:col-span-3 2xl:row-span-1  ",
    },
    {
        image: faultyCommits,
    ...
    },
    {
        ...
        link: "https://example.com/project1",
        className:
            "md:col-span-6 md:row-span-1 lg:col-span-4 lg:row-span-1 2xl:col-span-3 2xl:row-span-2  ",
    },
    {
        image: NGordNet,
        title: "NGordNet",
